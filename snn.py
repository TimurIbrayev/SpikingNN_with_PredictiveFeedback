...
if __name__ == '__main__':
    ...
    parser.add_argument('--test_only',              default=False,               type=bool,       help='perform only inference')
    ...
    identifier = 'snn_'+architecture.lower()+'_'+dataset.lower()+'_'+str(timesteps)+'_test_only'
